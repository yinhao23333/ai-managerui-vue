<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="configList">
      ...
      <el-table-column label="token" show-overflow-tooltip align="center" prop="token" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="text" icon="el-icon-copy-document"
            @click="copyCookie(scope.row)">复制token</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="token" prop="token">
          <el-input v-model="form.token" type="textarea" placeholder="请输入token"></el-input>
        </el-form-item>
      </el-form>
...
<script>
import { getMvTokenList, addMvTokenList } from "@/api/music/index";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      getMvTokenList(data).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.configId != undefined) {
            ...
            addMvTokenList(data).then(response => {
